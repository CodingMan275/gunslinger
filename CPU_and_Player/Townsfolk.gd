...
func initialize_townsfolk() -> void:
	...
	townsfolk_list.append(Town_Drunk.new())
	townsfolk_list.append(Bar_Keep.new())
	townsfolk_list.append(Ranch_Hand.new())
	townsfolk_list.append(Store_Keeper.new())
	townsfolk_list.append(Mountain_Man.new())
	townsfolk_list.append(Bounty_Hunter.new())
	townsfolk_list.append(Saloon_Girl.new())
	townsfolk_list.append(Bank_Manager.new())
