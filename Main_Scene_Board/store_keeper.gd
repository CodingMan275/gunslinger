...
func _ready() -> void:
	...
	#General Store
	RandSpawnLoc.append(Vector2(3,7))
	RandSpawnLoc.append(Vector2(4,7))
	#General Store Boardwalk
	RandSpawnLoc.append(Vector2(3,6))
	RandSpawnLoc.append(Vector2(4,6))
